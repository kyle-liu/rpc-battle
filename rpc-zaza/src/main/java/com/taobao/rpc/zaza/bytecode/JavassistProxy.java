 ...
 */
package com.taobao.rpc.zaza.bytecode;
...
import com.taobao.rpc.zaza.util.ClassHelper;
import com.taobao.rpc.zaza.util.ReflectUtils;
...
public abstract class JavassistProxy
{
	...
	{
		return getProxy(ClassHelper.getCallerClassLoader(JavassistProxy.class), ics);
	}
