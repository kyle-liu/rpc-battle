...
public final class MyMBeanServer {
    ...
    public void registerMBeanWithIdPrefix(final Object o, String idPrefix) {
        ...
        if (null != this.mbs) {
            ...
            try {
                tryRegisterMBeanWithIdPrefix(o, idPrefix);
            }
            catch (Throwable e) {
    ...
    /**
     * 防止多classloader环境下造成注册相同的objectName实例，by 水寒 2012-7
     * 
     * @param o
     * @param idPrefix
     ...
     */
    private void tryRegisterMBeanWithIdPrefix(final Object o, String idPrefix) throws MBeanRegistrationException,
