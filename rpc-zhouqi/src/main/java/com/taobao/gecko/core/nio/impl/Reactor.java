...
public final class Reactor extends Thread {
    ...
    private RpcRequestQueue requestQueue;
    ...
    Reactor(final SelectorManager selectorManager, final Configuration configuration, final int index)
        ...
        requestQueue=DisruptorQueueFactory.createDisruptorQueue();
    }

    
    public RpcRequestQueue getRequestQueue() {
		return requestQueue;
	}


	public void setRequestQueue(RpcRequestQueue requestQueue) {
